...
# Perdidas(Existencias que se arrastran al ejercicio siguiente)
...
```
Puedes identificar a los proveedores más confiables, (la mayoría de los proveedores en el top 10 tienen un porcentaje de entrega promedio cercano al 100%, lo que indica una alta fiabilidad.) que cumplen 
También puedes detectar a los que requieren revisión o renegociación, como el proveedor 1520.
...
Total no vendido
Hay un aumento muy claro en las unidades arrastradas cada año, especialmente en 2013 y 2014.
La empresa podría estar comprando más de lo que necesita, o ciertos productos tienen baja rotación.
